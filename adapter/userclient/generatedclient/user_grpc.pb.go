...
type UserServiceClient interface {
	...
	RemoveUser(ctx context.Context, in *RemoveUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) RemoveUser(ctx context.Context, in *RemoveUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	RemoveUser(context.Context, *RemoveUserRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) RemoveUser(context.Context, *RemoveUserRequest) (*UserResponse, error) {
